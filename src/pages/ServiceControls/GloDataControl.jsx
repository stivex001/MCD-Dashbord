...
const GloDatacontrol = () => {
  ...
  const [inputAmount, setInputAmount] = useState(gloList?.amount);
  const [inputNote, setInputNote] = useState(gloList?.note);
  const [inputServer, setInputServer] = useState(gloList?.server);
